...
function attachDropzone(){
  if(typeof Dropzone != "undefined"){
    ...
    js.src = '/static/js/dropzone.js';
    js.charset = 'UTF-8';
    js.onload = bindUpload;
...
function bindUpload(){
  ...
  dzUpload = new Dropzone("textarea", { 
    url: "/api/file/simpleUpload" , 
    maxFilesize:"1024" , 
    uploadMultiple: false
  });
  dzUpload.on("addedfile",function(){
    showPreloader("正在上传文件");
  });
  dzUpload.on("error",function(){
  ...
  dzUpload.on("success",function(e){
    try{
      ...
      if(iurl.indexOf(".") > 0){
        ...
        mdContent = "!["+fname+"]("+iurl+")";
      }else{
        if(!fname){
          fname = "Attachment";
        }
        var fsize = (e.size/1024/1024).toFixed(2);
        mdContent = "[Download "+fname+" - "+fsize+"MB]("+iurl+")";
      }
